...
Design and develop an edge device capable to support a constrained device to create and
manage its own self-sovereign-identity
...
\input{chapters/chapter1-keystone.tex}
