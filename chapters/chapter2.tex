...
It is apparent from the table \ref{time-table1} that RSA is unusable on constrained devices in real-life applications because the ... [da continuare]  
...
\faEye\enspace Note the order of magnitude of the percentage increase, the time differences between an MCU and a CPU and their frequency of operation
